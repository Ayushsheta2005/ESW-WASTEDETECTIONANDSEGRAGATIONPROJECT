...
# st.sidebar.markdown("### Real-Time Detection Summary")
# st.sidebar.metric(label="Recyclable Items Detected", value=len(recyclable_items))
# st.sidebar.metric(label="Non-Recyclable Items Detected", value=len(non_recyclable_items))
# st.sidebar.metric(label="Hazardous Items Detected", value=len(hazardous_items))
...
<style>
    .stRecyclable {
        background-color: rgba(60, 185, 113,255);
